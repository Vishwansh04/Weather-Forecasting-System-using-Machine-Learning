...
Label(root,image=Round_box,bg = "#ff7357").place(x=30,y=110)
...
myimage =Label(image=Search_image,bg="#ff7357")
...
clock=Label(root,font=("Helvetica",30,'bold'),fg="white",bg="#ff7357")
clock.place(x=30,y=20)

#timezone
timezone=Label(root,font=("Helvetica",20),fg="white",bg="#ff7357")
timezone.place(x=700,y=20)


long_lat=Label(root,font=("Helvetica",10),fg="white",bg="#ff7357")
